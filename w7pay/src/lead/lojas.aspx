<%@ Page Title="" Language="C#" MasterPageFile="~/src/lead/masterlead.Master" AutoEventWireup="true" CodeBehind="lojas.aspx.cs" Inherits="w7pay.src.lead.lojas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                    ...
                    <h1 class="mb-0 pb-0 display-6" id="title">Lojas</h1>
                </div>
            </div>
            <!-- Title End -->
        </div>
    ...
    <!-- Order List Start -->
            ...
            <div class="col-12 mb-5">              
              <asp:GridView ID="gdvDados" Width="100%" runat="server" CellPadding="4" EmptyDataText="Não há dados para visualizar" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataSourceID="sdsDados">
                  ...
                  <Columns>
                      ...
                      <asp:BoundField DataField="name" HeaderText="Loja" SortExpression="name" />                      
                      <asp:BoundField DataField="city" HeaderText="Cidade" SortExpression="city" />
                      <asp:BoundField DataField="state" HeaderText="UF" SortExpression="state" />
                  </Columns>
         ...
         <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select c.name as nomecliente, * from locais l left join clientes c on c.id = l.client_id order by c.name, l.name">
                </asp:SqlDataSource>
            </div>
          </div>
          <!-- Order List End -->
