<%@ Page Title="" Language="C#" MasterPageFile="~/src/admin/principal.Master" AutoEventWireup="true" CodeBehind="maquina.aspx.cs" Inherits="w7pay.src.maquina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                    ...
                    <h1 class="mb-0 pb-0 display-6" id="title">Máquinas</h1>
                </div>
            </div>
            <!-- Title End -->
        </div>
    ...
    <!-- Order List Start -->
         ...
         <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select m.id, asset_number, l.name as nomelocal, cash_mode from maquinas m
left join locais l on l.id = m.location_id
order by l.name, m.asset_number">
                </asp:SqlDataSource>
            </div>
          </div>
          <!-- Order List End -->
