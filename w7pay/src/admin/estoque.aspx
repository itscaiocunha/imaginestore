            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12 col-md-5 col-lg-4 col-xxl-2 mb-1">
                    <div class="">
                        ...
                        <asp:DropDownList ID="ddlCategoria" runat="server" CssClass="form-control shadow dropdown-menu-end" DataSourceID="sdsCategoria" DataTextField="descricao" DataValueField="id">
                        </asp:DropDownList>
                            ...
                            <div class="h-100">
                                <div class="col-12 mb-5" style="overflow-y:scroll; height:400px">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="
                                        select max(c.descricao) as client, isnull(max(e.sald), '0') as saldo from estoque1 e (nolock)
