<%@ Page Title="" Language="C#" MasterPageFile="~/src/lead/masterlead.master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="w7pay.src.lead.dashboard2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    ...
    <!-- Stats End -->
        ...
        <div class="col-xl-4 mb-5">
         ...
         <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select count(quantity) as qtde, sum(value) as fatura, max(c.name) as nomecliente from vendas v (nolock)
...
order by qtde">
    ...
    <Series>
        ...
        <asp:Series Name="Series2" ChartType="Spline" YValuesPerPoint="4" XValueMember="mesano" YValueMembers="qtde" IsValueShownAsLabel="true"></asp:Series>
    </Series>
    <ChartAreas>
            <asp:ChartArea Name="ChartArea1">
    <AxisY IntervalType="Number" LineDashStyle="NotSet">
