<%@ Page Title="" Language="C#" MasterPageFile="~/src/admin/principal.Master" AutoEventWireup="true" CodeBehind="vendas_fornecedor.aspx.cs" Inherits="w7pay.src.vendas_fornecedor" %>
                ...
                <div class="row">
                    ...
                    <div class="col-auto mb-3 mb-md-0 me-auto">
                        <div class="w-auto sw-md-30">
                            ...
                            <h1 class="mb-0 pb-0 display-6" id="title">Relatório de Vendas/Fornecedor</h1>
                        </div>
                    </div>
                    <!-- Title End -->
                </div>
