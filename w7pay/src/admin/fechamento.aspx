<%@ Page Title="" Language="C#" MasterPageFile="~/src/admin/principal.Master" AutoEventWireup="true"
    CodeBehind="fechamento.aspx.cs" Inherits="w7pay.src.fechamento" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="row mb-2">
                    ...
                    <!-- Search Start -->
                    <div class="col-sm-12 col-md-8 col-lg-6 col-xxl-4 mb-1">
                        <div class="">
                            <label>Fornecedor</label>
                            <asp:DropDownList ID="ddlFornecedor" AppendDataBoundItems="true" runat="server"
                                CssClass="form-control shadow dropdown-menu-end" DataSourceID="sdsFornecedor"
                                DataTextField="nomecompleto" DataValueField="id">
                                <asp:ListItem Text="Selecione o fornecedor" Value="0"></asp:ListItem>
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="sdsFornecedor" runat="server"
                                ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                SelectCommand="select name as nomecompleto, id from fornecedores order by name">
                            </asp:SqlDataSource>
                        </div>
                    </div>
...
where idfornecedor = @id and mesano = convert(varchar,@mes)+'/'+convert(varchar,@ano) order by faturamento desc">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="ddlFornecedor" Name="id"
