...
namespace w7pay
{
    internal class atualizacao
    {
        ...
        public static void GETVendas()
        {
            ...
            var client = new RestClient($"https://vmpay.vertitecnologia.com.br/api/v1/cashless_facts?access_token=04PJ5nF3VnLIfNLJRbqmZkEMhU2VNCClOjPoTPCI&start_date=28/05/2024&end_date=03/06/2024&page=1&per_page=1000");
            var request = new RestRequest(Method.GET);
            request.AddHeader("Accept", "application/json");
