<%@ Page Title="" Language="C#" MasterPageFile="~/src/cliente/master.master" AutoEventWireup="true" Async="true" CodeBehind="busca.aspx.cs" Inherits="w7pay.src.cliente.busca" %>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4">
                        <div class="product-widget mb-30">
                            <h5 class="pt-title">Categoria de Produtos</h5>
                            <div class="widget-category-list mt-20" style="font-size:0.8em; cursor:pointer">
                               <asp:RadioButtonList ID="rblCategorias" runat="server" DataSourceID="sdsCategoriasLista" DataTextField="descricao" DataValueField="category_id">

                               </asp:RadioButtonList>
            <asp:SqlDataSource ID="sdsCategoriasLista" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select p.category_id, max(c.descricao)+' ('+convert(varchar,count(p.id))+')' as descricao from produtos p join categorias c on c.id = p.category_id 
group by p.category_id
order by descricao"></asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="product-widget mb-30">
                            <h5 class="pt-title">Filtrar por preço</h5>
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="shop-banner mb-30">
                            <div class="banner-image">
                                <img class="banner-l" src="assets/img/banner/11.png" alt="">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                        <div class="product__filter-right d-flex align-items-center justify-content-md-end">
                                            ...
                                            <asp:DropDownList ID="ddlQtdePagina" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlQtdePagina_SelectedIndexChanged">
                                            ...
                                            <div class="product__sorting product__show-position ml-20">
                                                <asp:DropDownList ID="ddlOrdenar" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlOrdenar_SelectedIndexChanged">
                                                    <asp:ListItem Text="Maior Relevância"></asp:ListItem>
                                                    <asp:ListItem Text="Recentes"></asp:ListItem>
                                                    <asp:ListItem Text="Menor Preço"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
